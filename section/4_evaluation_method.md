...
MAESTROには、用意されたDFD図に対して下記の流れで実施しました。

1. DFD図に対して、OWASP Agentic Security Initiative (ASI) による 「Agentic AI – Threats and Mitigations (Version 1.1)」 の Detailed Threat Model (T1-T17)を適用して脅威を特定する。
